...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_luoda_password_tip", "Įveskite kliento luoda slaptažodį"),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_luoda_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės luoda klientą į {} ar naujesnę versiją!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
