...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_luoda_password_tip", "Επιβεβαιώστε τον κωδικό του luoda"),
        ...
        ("upgrade_luoda_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε τον luoda Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("During service is on", "Κατα την εκκίνηση της υπηρεσίας luoda"),
        ...
        ("upgrade_remote_luoda_client_to_{}_tip", "Αναβαθμίστε τον πελάτη luoda στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
