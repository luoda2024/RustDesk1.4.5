...
///
/// Note:
/// On linux, we use dbus to communicate multiple luoda process.
...
const DBUS_NAME: &str = "org.luoda.luoda";
...
/// `dbus-send --session --print-reply --dest=org.luoda.luoda /dbus org.luoda.luoda.NewConnection string:'PEER_ID'`
